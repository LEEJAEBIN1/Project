...
/* RAM BLOCKS */
uint RAM_BLOCK_SIZE = 64;
uint NUM_OF_CACHE_DATA_BLOCK = 60;
uint NUM_OF_CACHE_ECC_BLOCK = 4;
uint ERROR_4_20 = 0;
uint ERROR_8_24 = 0;
uint ERROR_12_28 = 0;
void load_entry(char *name, double value, uint line_number) {
	...
	else if (!strcmp(name, "RAM_BLOCK_SIZE"))
		RAM_BLOCK_SIZE = value;
	else if (!strcmp(name, "NUM_OF_CACHE_DATA_BLOCK"))
		NUM_OF_CACHE_DATA_BLOCK = value;
	else if (!strcmp(name, "NUM_OF_CACHE_ECC_BLOCK"))
		NUM_OF_CACHE_ECC_BLOCK = value;
	else if (!strcmp(name, "ERROR_4_20"))
		ERROR_4_20 = value;
	else if (!strcmp(name, "ERROR_8_24"))
		ERROR_8_24 = value;
	else if (!strcmp(name, "ERROR_12_28"))
		ERROR_12_28 = value;
	else
...
void print_config(FILE *stream) {
	...
	fprintf(stream, "RAM_BLCK_SIZE: %i\n", RAM_BLOCK_SIZE);
	return;
}
