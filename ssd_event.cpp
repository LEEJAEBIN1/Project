...
void Event::set_eccLpn(int lpn,int eccnum)
{
	this->eccLpn[eccnum] = lpn;
}
int Event ::get_eccLpn(int eccnum)
{
	return this->eccLpn[eccnum];
}
...
void Event::set_eccnum(int eccnum)
{
	this->ecc_num = eccnum;
}
int Event::get_eccnum()
{
	return this->ecc_num;
}
...
void Event::set_payload_parity(void *payload_parity)
{
	this->payload_parity = payload_parity;
}
void *Event::get_payload(void) const
{
	return payload;
}
void *Event::get_payload_parity(void) const
{
	return payload_parity;
}
